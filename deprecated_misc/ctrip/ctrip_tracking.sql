...
,CASE WHEN co.AVSRESULT in ('Z','A','W','D') THEN 'Partial AVS' WHEN co.AVSRESULT in ('X','Y','M','F','P') THEN 'Full AVS' WHEN co.AVSRESULT in ('N') THEN 'Neither ZIP nor address match' WHEN co.AVSRESULT in ('I') THEN 'Not verified for Intl trxn' WHEN co.AVSRESULT in ('U','G','R','0','S') THEN 'Unsupp/Inconc AVS' END
...
WHERE co.AUTHORISATIONDATETIME>=TO_DATE('2018-04-04','YYYY-MM-DD')
