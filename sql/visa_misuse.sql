...
(SELECT 
    ...
    WHERE MATCH_DATE BETWEEN TO_DATE('12/1/2018','MM/DD/YYYY') AND TO_DATE('12/31/2018','MM/DD/YYYY')
...
AND PA.MERCHANTID=CC.CONTRACT_ID
AND pa.currencycode=cc.transaction_currency
AND co.IIN=cc.BIN
WHERE pa.statusdate BETWEEN TO_DATE('12/1/2018','MM/DD/YYYY') AND TO_DATE('12/31/2018','MM/DD/YYYY')
AND pa.statusid in (525,600)
and paymentproductid=1
and serviceaccountname NOT IN('RetailDecisions HS','PagoCC')
