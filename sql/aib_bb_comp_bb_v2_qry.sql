...
from
  ...
  where bb.settlement_date between to_date('01-01-2018','MM-DD-YYYY') and to_date('03-31-2018','MM-DD-YYYY')
  and bb.additional_ref_2 not in('0')) t1
left join 
  ...
  and t1.bambora_transaction_type='Sale'